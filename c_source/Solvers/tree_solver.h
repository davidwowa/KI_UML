/*--------------------------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------------------------- */
#ifndef AI_Solvers_tree_solver_H
#define AI_Solvers_tree_solver_H

#include "AI_Solvers.h"
#include <WST_Types.h>
#include <stdlib.h>

/* ## This file contains declaration code for AI::Solvers::tree_solver  */

/* ## class data struct */

typedef struct AI_Solvers_tree_solver_struct {
	int EMPTY_STRUCT;
} AI_Solvers_tree_solver;
...
struct AI_Solvers_tree_solver_struct* AI_Solvers_tree_solver_New(void);
